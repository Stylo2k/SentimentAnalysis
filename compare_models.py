...
me_and_alpaca_bitcoin_and_alpaca_nobitcoin = [alshakoush_sentiments, alpaca_bitcoin_sentiments, alpaca_nobitcoin_sentiments]
print('Me & Alpaca Bitcoin & Alpaca No Bitcoin: ' + str(krippendorff.alpha(reliability_data=me_and_alpaca_bitcoin_and_alpaca_nobitcoin)))
